...
while diff > 0.1
    ...
    for i = 1:8
        [r_ej(:,i),v_ej(:,i)] = Satellite_position_and_velocity(0,satellite_j(i));
    end
    ...
    [L_b_1b,lambda_b_1b,h_b_1b,v_eb_n_1b] = pv_ECEF_to_NED(r_ea(:,:,1),0);

    L_b_1b = rad2deg(L_b_1b);
    lambda_b_1b = rad2deg(lambda_b_1b);
    h_b_1b;
